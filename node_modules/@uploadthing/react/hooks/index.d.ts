...
declare const generateReactHelpers: <TRouter extends FileRouter>(initOpts?: GenerateTypedHelpersOptions) => {
    ...
    readonly uploadFiles: <TEndpoint extends keyof TRouter, TSkipPolling_1 extends boolean = false>(endpoint: TEndpoint, opts: Omit<uploadthing_types.UploadFilesOptions<TRouter, TEndpoint, TSkipPolling_1>, keyof uploadthing_types.GenerateUploaderOptions>) => Promise<uploadthing_types.ClientUploadedFileData<false extends TSkipPolling_1 ? uploadthing_types.inferEndpointOutput<TRouter[TEndpoint]> : null>[]>;
    /**
