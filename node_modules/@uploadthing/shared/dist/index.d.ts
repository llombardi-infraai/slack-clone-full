...
declare const parseRequestJson: (req: Request) => Micro.Micro<unknown, InvalidJsonError, never>;
/**
 * Schedule that retries with exponential backoff, up to 1 minute.
 * 10ms * 4^n, where n is the number of retries.
 */
declare const exponentialDelay: () => Micro.MicroSchedule;
