...
import { HttpRouter, HttpBody, HttpServerRequest } from '@effect/platform';
...
declare const createRouteHandler: <TRouter extends FileRouter>(opts: RouteHandlerOptions<TRouter>) => HttpRouter.HttpRouter<HttpBody.HttpBodyError, never>;
